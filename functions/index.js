...
exports.sendEmailToCostumer = functions.https.onRequest((req, res) => {
    ...
    const mailOptions = {
        from: `firebaseGCE@gmail.com`,
        to: obj[0],
        subject: 'Crear proyecto con GoConsultingEurope',
        html: `<h1>Orden recibida</h1>
                <p> <b>Tu correo: </b>${obj[0]}</p>
                <p> <b>Respuesta 1: ¿Qué tipo de web estás buscando? - </b>${obj[1]}</p>
                <p> <b>Respuesta 2: ¿Qué diseño quieres que tenga tu Web? - </b>${obj[2]}</p>
                <p> <b>Respuesta 3: ¿En qué etapa se encuentra tu web? - </b>${obj[3]}</p>
                <p> <b>Respuesta 4: ¿Qué tanta información necesita tu web? - </b> paginas: ${obj[4][0]}, productos: ${obj[4][1]}, idiomas:${obj[4][2]}</p>
                <p> <b>Respuesta 5: ¿Necesitas ayuda en la creación de textos o imágenes? - </b>${obj[5][0]}, ${obj[5][1]}, ${obj[5][2]}</p>
                <p> <b>Respuesta 6: ¿Tu web necesita alguno de los siguientes? - </b>${obj[6][0]}, ${obj[6][1]}, ${obj[6][2]}</p>
                <p> <b>Respuesta 7: ¿Tu web necesita servicios de SEO? - </b>${obj[7]}</p>
                <p> <b>Price: </b>${obj[8]} €</p>
                <p> <b>Plan: </b>${obj[9]}</p>
